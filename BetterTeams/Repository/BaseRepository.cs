...
namespace Repository
{
    public class BaseRepository : IDisposable
    {
        ...
        public BaseRepository()
        {
            ...
            //Azure Connection
            string connectionString = @"Server=betterteams,1433;Initial Catalog=BetterTeamsAzure;Persist Security Info=False;User ID=;Password=;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=50;";
